...
(setq-default battery-mode-line-format (propertize "{%p}" 'face '(:foregorund "#ffffff")))
...
(setq-default mode-line-format
     '((:eval
       ...
       (format-mode-line
        (list
         (propertize "%4l " 'face `(:inherit face-faded))
         ;;mode-line-misc-info
         "  "))))))
...
(defun elegance-light ()
    ...
    (set-face-attribute 'face-popout nil :foreground "#0010ff")
    (set-face-attribute 'face-strong nil :foreground "#333333"
                                         :weight 'regular)
    ;;(set-face-attribute 'face-salient nil :foreground "#d4817b"
    ;;                                      :weight 'regular)
    (set-face-attribute 'face-salient nil :foreground "#a42af1"
                                          :weight 'regular)
...
(set-face 'show-paren-match                              'face-strong)
